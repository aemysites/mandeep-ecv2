...
## Environments
- Preview: https://main--mandeep-ecv2--aemysites.aem.page/
- Live: https://main--mandeep-ecv2--aemysites.aem.live/
- Block Library: https://main--mandeep-ecv2--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `mandeep-ecv2` directory in your favorite IDE and start coding :)
